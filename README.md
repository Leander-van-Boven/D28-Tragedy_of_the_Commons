...
* The \_Code folder contains the code for the model:
  ...
  - [`parameters.py`](https://github.com/Leander-van-Boven/D28-Tragedy_of_the_Commons/blob/master/_Code/name_of_beautiful_project/parameters.py) consists of multiple dictionaries. Each dictionary contains the default parameters for each class in the model.
